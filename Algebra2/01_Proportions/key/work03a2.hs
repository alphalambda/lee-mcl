...
solution03 = anjali_speed
    where anjali_speed = blank

-- Problem 4
-- Shreya left the science museum and
-- travelled toward the mountains at an
-- average speed of 24 mph. Matt left some
-- time later travelling in the same direction
-- at an average speed of 60 mph. After travelling for
